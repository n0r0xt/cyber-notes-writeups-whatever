# Cover all your bases writeup
## this is my writeup for the cover all your bases warmup challenge in huntress CTF 2025
...
```
To solve, convert from binary. Here's the plaintext:
```shell
...
143 071 175
```
To solve, convert from octal. Here's the plaintext:
```shell
...
053 048 125
```
To solve, convert from decimal. Here's the plaintext:
```shell
...
```
To solve, convert from hex. Here's the plaintext:
```shell
...
MZRDEOLDMN6Q====
```
To solve, convert from base32. Here's the plaintext:
```shell
...
7YJC2R6J-CZ2
```
To solve, convert from base45. Here's the plaintext:
```shell
...
```
To solve, convert from base64. Here's the plaintext:
```shell
...
```
To solve, convert from base85. Here's the plaintext:
```shell
...
```
To solve, remove spaces and newlines and convert from base92. Here's the plaintext:
```shell
...
```
To solve, convert from base 65536. Here's the plaintext:
```shell
